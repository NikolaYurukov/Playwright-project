...
2. Clone the repo
   ```sh
   git clone https://github.com/NikolaYurukov/Playwright-project.git
   ```
...
Nikola Yurukov - Nik.yurukov@mail.com

Project Link: [https://github.com/NikolaYurukov/Playwright-project.git](https://github.com/NikolaYurukov/Playwright-project.git)
